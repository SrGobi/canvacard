...
/**
 * @name getDateOrString
 * @description Gets a formatted date string or returns the input as is.
 ...
 * @param {string} [localDateType='en'] The locale for the date format (default is English).
